...
def CNN_symmetricSkip_8L (frame, batch_size, width, height):
    ...
    de_conv4 = tf.nn.conv2d_transpose(conv4, d_w4,
                                      output_shape = [batch_size, width, height, 290],
                                      strides=[1, 1, 1, 1],
                                      padding='SAME')
...
def image_show():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "C:\\Users\\lyf58\\PycharmProjects\\ModelParameters\\model_reconstruction_mu35_ptg20_Skip8Layer_scannedPixelRemoved.ckpt")
        ...
        try:
            for _ in np.arange(max_step):
                ...
                ax1.set_title("undersampled image")
