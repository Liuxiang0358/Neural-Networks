...
def image_show():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "C:\\Users\\lyf58\\PycharmProjects\\ModelParameters\\model_reconstruction_mu35_ptg20_Skip8Layer.ckpt")
        ...
        try:
            for _ in np.arange(max_step):
                ...
                ax2.imshow(recovered_image[0, :, :, 0], cmap='gray')
